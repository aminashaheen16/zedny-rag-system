...
def test_tech_restore_v2():
    ...
    print(f"   Answer Length: {len(answer1)}")
    print(f"   Response Preview: {answer1[:300]}...")
    ...
    # Test Case 2: "Can't login" -> Newly added keywords
    payload2 = {
        "message": "لا استطيع تسجيل الدخول",
        "session_id": "final_verify_login",
        "user_email": "verify@test.com"
    }
    ...
    if "تسجيل دخول" in answer2 or "كوكيز" in answer2 or "متصفح" in answer2:
        print("✅ SUCCESS: Login solution delivered.")
    else:
        print("❌ FAILED: Login solution NOT delivered.")

    # Test Case 3: Vague issue -> Should trigger Discovery
    payload3 = {
        "message": "عندي مشكلة",
        "session_id": "final_verify_vague",
        "user_email": "verify@test.com"
    }
